            ...
            <section className="bg-white ">
                <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                    <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
                        ...
                        <p className="font-light text-gray-500 sm:text-xl">Meet the driving force behind Surplus Education Consultancy </p>
                    </div>
                    <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                        {teams.map((value, index) => (
                            <div key={index} className="text-center text-gray-500">
                                <div className="mx-auto mb-4 w-36 h-36 rounded-full overflow-hidden">
                                    <img className="w-full h-full hover:scale-110  transition duration-500 ease-linear" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png" alt="Bonnie Avatar" />
                                </div>
                                <h3 className="mb-1 cursor-default text-2xl font-bold tracking-tight text-gray-900">
                                    {value.name}
                                </h3>
                                <p className='cursor-default'>{value.position}</p>
                                <ul className="flex justify-center mt-4 space-x-4">
                                    <li className='hover:-translate-y-1.5 transition-all duration-300 ease-linear'>
